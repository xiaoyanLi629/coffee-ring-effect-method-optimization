...
for i in conditions:
	CMDS_coordinates = genfromtxt(chr(i) + '_pixel_coordinates/' + chr(i) + '_js_coordinates.csv', delimiter=',')
	...
	# plt.show()
	filename = 'CMDS_scatter_image/' + chr(i) + '_js_coordinates.png'
...
conditions = range(65, 65+9)
for i in conditions:
	MDS_coordinates = genfromtxt(chr(i) + '_pixel_coordinates/' + chr(i) + '_js_coordinates.csv', delimiter=',')
	...
	# plt.show()
	filename = 'MDS_scatter_image/' + chr(i) + '_js_coordinates.png'
	plt.savefig(filename, bbox_inches='tight', dpi = 600)