...
try: 
    os.mkdir('Eccen_js_distances_matrix_image')
...
for i in conditions:
	js_matrix = genfromtxt('Eccentricity_js_matrix_adjusted/' + chr(i) + '.csv', delimiter=',')
	# print(js_matrix)
	...
	filename = 'Eccen_js_distances_matrix_image/' + chr(i) + '_js_distance.png'
