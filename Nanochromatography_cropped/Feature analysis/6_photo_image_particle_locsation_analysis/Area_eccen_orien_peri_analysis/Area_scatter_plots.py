...
# CMDS coordinates
try: 
    os.mkdir('Area_CMDS_scatter_image')
...
for i in conditions:
	CMDS_coordinates = genfromtxt('Area_MDS_coordinates/' + chr(i) + '.csv', delimiter=',')
	...
	# plt.show()
	filename = 'Area_CMDS_scatter_image/' + chr(i) + '_js_coordinates.png'
	plt.savefig(filename, bbox_inches='tight', dpi = 600)


# MDS coordinates
try: 
    os.mkdir('Area_MDS_scatter_image')
except OSError as error: 
    print(error)

conditions = range(65, 65+9)
for i in conditions:
	MDS_coordinates = genfromtxt('Area_MDS_coordinates/' + chr(i) + '.csv', delimiter=',')
	...
	# plt.show()
	filename = 'Area_MDS_scatter_image/' + chr(i) + '_js_coordinates.png'
	plt.savefig(filename, bbox_inches='tight', dpi = 600)