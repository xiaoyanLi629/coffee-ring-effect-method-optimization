...
# CMDS coordinates
try: 
    os.mkdir('Orien_CMDS_scatter_image')
...
for i in conditions:
	CMDS_coordinates = genfromtxt('Orientation_MDS_coordinates/' + chr(i) + '.csv', delimiter=',')
	...
	# plt.show()
	filename = 'Orien_CMDS_scatter_image/' + chr(i) + '_js_coordinates.png'
	plt.savefig(filename, bbox_inches='tight', dpi = 600)


# MDS coordinates
try: 
    os.mkdir('Orien_MDS_scatter_image')
except OSError as error: 
    print(error)

conditions = range(65, 65+9)
for i in conditions:
	MDS_coordinates = genfromtxt('Orientation_MDS_coordinates/' + chr(i) + '.csv', delimiter=',')
	...
	# plt.show()
	filename = 'Orien_MDS_scatter_image/' + chr(i) + '_js_coordinates.png'
	plt.savefig(filename, bbox_inches='tight', dpi = 600)