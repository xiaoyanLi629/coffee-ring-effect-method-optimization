...
try: 
    os.mkdir('Orien_js_distances_matrix_image')
...
for i in conditions:
	js_matrix = genfromtxt('Orientation_js_matrix_adjusted/' + chr(i) + '.csv', delimiter=',')
	# print(js_matrix)
	...
	filename = 'Orien_js_distances_matrix_image/' + chr(i) + '_js_distance.png'
