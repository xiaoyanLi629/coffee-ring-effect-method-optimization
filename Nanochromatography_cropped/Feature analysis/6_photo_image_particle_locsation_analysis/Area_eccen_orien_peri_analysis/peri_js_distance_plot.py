...
try: 
    os.mkdir('Peri_js_distances_matrix_image')
...
for i in conditions:
	js_matrix = genfromtxt('Perimeter_js_matrix_adjusted/' + chr(i) + '.csv', delimiter=',')
	# print(js_matrix)
	...
	filename = 'Peri_js_distances_matrix_image/' + chr(i) + '_js_distance.png'
